...
class PageWishlistProgress extends StatefulWidget {
  const PageWishlistProgress({super.key});

  @override
  State<PageWishlistProgress> createState() => _PageWishlistProgress();
}

class _PageWishlistProgress extends State<PageWishlistProgress> {
  @override
